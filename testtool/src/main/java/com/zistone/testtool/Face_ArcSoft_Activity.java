 ...
 */
public class Face_ArcSoft_Activity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "Face_ArcSoft_Activity";
    ...
    public void ActiveEngine() {
        ...
        Observable.create(new ObservableOnSubscribe<Integer>() {
            ...
            public void subscribe(ObservableEmitter<Integer> emitter) {
                ...
                int activeCode = FaceEngine.activeOnline(Face_ArcSoft_Activity.this, Constants.APP_ID, Constants.SDK_KEY);
            ...
            public void onNext(Integer activeCode) {
                ...
                int res = FaceEngine.getActiveFileInfo(Face_ArcSoft_Activity.this, activeFileInfo);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arcsoft_menu);
